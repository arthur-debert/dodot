...
// # Overview
//
// The PathPowerUp automatically adds directories from your dotfile packs to the system PATH.
...
// 4. **PowerUp Invocation**: Matched directories are passed to PathPowerUp.Process()
//
...
// # Options
//
// The PathPowerUp accepts these options:
//
...
//  3. PathPowerUp creates ActionTypePathAdd for the directory
...
//
// - **ShellProfilePowerUp**: For general shell configuration
// - **PathPowerUp**: Specifically for PATH modifications
// - **SymlinkPowerUp**: For individual file links
// - **InstallScriptPowerUp**: For one-time setup
//
// Use PathPowerUp when you have directories of executables or scripts that
