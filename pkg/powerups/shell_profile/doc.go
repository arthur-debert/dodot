...
// # Overview
//
// The ShellProfilePowerUp manages shell configuration by sourcing shell scripts into
...
// 4. **PowerUp Invocation**: Matched files are passed to ShellProfilePowerUp.Process()
//
...
// # Options
//
// Currently, ShellProfilePowerUp accepts no configuration options.
...
//  3. ShellProfilePowerUp creates ActionTypeShellSource action
...
//
// - **SymlinkPowerUp**: For static config files
// - **PathPowerUp**: Specifically for PATH modifications
// - **ShellProfilePowerUp**: For dynamic shell environment setup
// - **InstallScriptPowerUp**: For one-time setup tasks
//
// Use ShellProfilePowerUp when you need to add dynamic behavior to your shell
