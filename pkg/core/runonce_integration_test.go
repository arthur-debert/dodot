...
func TestRunOncePowerUpsIntegration(t *testing.T) {
	...
	// Calculate checksums
	brewChecksum, err := powerups.CalculateFileChecksum(brewfilePath)
	testutil.AssertNoError(t, err)
	installChecksum, err := powerups.CalculateFileChecksum(installPath)
	testutil.AssertNoError(t, err)
	...
	newBrewChecksum, err := powerups.CalculateFileChecksum(brewfilePath)
	testutil.AssertNoError(t, err)
...
func TestRunOncePowerUpsWithMultiplePacks(t *testing.T) {
	...
	for _, pack := range packs {
		...
		checksum, err := powerups.CalculateFileChecksum(brewfilePath)
		testutil.AssertNoError(t, err)
