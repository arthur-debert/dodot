...
func TestDirectExecutorPOC_SymlinkPowerUp(t *testing.T) {
	...
	// Create executor
	executor := NewDirectExecutorPOC(opts)
...
func TestDirectExecutorPOC_WritePowerUp(t *testing.T) {
	// Setup test environment
...
func TestDirectExecutorPOC_RunAction(t *testing.T) {
	// Setup test environment
...
func TestDirectExecutorPOC_MkdirAction(t *testing.T) {
	// Setup test environment
...
func TestDirectExecutorPOC_MixedPowerUps(t *testing.T) {
	// Setup test environment
...
func TestDirectExecutorPOC_DryRun(t *testing.T) {
	// Setup test environment
...
func TestDirectExecutorPOC_ValidationErrors(t *testing.T) {
	// Setup test environment
...
func TestDirectExecutorPOC_ForceMode(t *testing.T) {
	// Setup test environment
