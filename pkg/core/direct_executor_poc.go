...
// DirectExecutorPOCOptions contains options for the direct executor POC
type DirectExecutorPOCOptions struct {
	Paths             *paths.Paths
	DryRun            bool
	Force             bool
...
// DirectExecutorPOC executes actions directly without intermediate Operation type
// This is a POC to validate the new architecture
type DirectExecutorPOC struct {
...
// NewDirectExecutorPOC creates a new direct executor for POC
func NewDirectExecutorPOC(opts *DirectExecutorPOCOptions) *DirectExecutorPOC {
	...
	return &DirectExecutorPOC{
		logger:            logging.GetLogger("core.direct_executor_poc"),
		dryRun:            opts.DryRun,
		force:             opts.Force,
...
func (e *DirectExecutorPOC) ExecuteActions(actions []types.Action) ([]types.OperationResult, error) {
	if len(actions) == 0 {
		return []types.OperationResult{}, nil
	}

	e.logger.Info().Int("actionCount", len(actions)).Msg("Executing actions directly (POC)")
...
func (e *DirectExecutorPOC) convertActionToSynthfsOps(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
	switch action.Type {
...
func (e *DirectExecutorPOC) convertLinkAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
...
func (e *DirectExecutorPOC) convertCopyAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
	if action.Source == "" || action.Target == "" {
...
func (e *DirectExecutorPOC) convertWriteAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
	if action.Target == "" {
...
func (e *DirectExecutorPOC) validatePath(path string) error {
	op := types.Operation{
...
func (e *DirectExecutorPOC) validateSymlinkPaths(source, target string) error {
	op := types.Operation{
...
func (e *DirectExecutorPOC) executeDryRun(actions []types.Action) []types.OperationResult {
...
func (e *DirectExecutorPOC) logAction(action types.Action) {
...
func (e *DirectExecutorPOC) convertResults(result *synthfs.Result, actionMap map[synthfs.OperationID]*types.Action) []types.OperationResult {
	if result == nil {
...
func (e *DirectExecutorPOC) convertAppendAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
	if action.Target == "" {
...
func (e *DirectExecutorPOC) convertMkdirAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
	if action.Target == "" {
...
func (e *DirectExecutorPOC) convertShellSourceAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
	if action.Source == "" {
...
func (e *DirectExecutorPOC) convertPathAddAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
	if action.Target == "" {
...
func (e *DirectExecutorPOC) convertRunAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
	if action.Command == "" {
...
func (e *DirectExecutorPOC) convertBrewAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
	// Execute brew bundle
	return nil, errors.New(errors.ErrNotImplemented, "brew action not implemented in POC")
}

func (e *DirectExecutorPOC) convertInstallAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
	// Execute install script
	return nil, errors.New(errors.ErrNotImplemented, "install action not implemented in POC")
}

func (e *DirectExecutorPOC) convertTemplateAction(sfs *synthfs.SynthFS, action types.Action) ([]synthfs.Operation, error) {
