...
// # Overview
//
// The BrewHandler processes Brewfiles to install packages via Homebrew on macOS and Linux.
...
// # Brewfile Syntax
//
// BrewHandler supports all standard Brewfile commands:
//
...
// # Options
//
// Currently, BrewHandler accepts no configuration options.
...
//
// - **InstallScriptHandler**: For complex installations Homebrew can't handle
// - **BrewHandler**: For system packages and macOS applications
// - **SymlinkHandler**: For configuration files (deploy phase)
// - **ProfileHandler**: For shell configuration (deploy phase)
//
// Use BrewHandler for system-level package management, especially when you want
