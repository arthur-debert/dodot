...
// SimplifiedHandler demonstrates how the path handler looks in the new architecture.
...
// NewSimplifiedHandler creates a new simplified path handler.
...
func (h *SimplifiedHandler) Name() string {
	return "path"
}

// Category returns the handler category.
func (h *SimplifiedHandler) Category() handlers.HandlerCategory {
