...
func TestScanner_ScanPack(t *testing.T) {
	t.Run("exact_filename_match", func(t *testing.T) {
		...
		scanner := handlerpipeline.NewScannerWithFS(ruleList, env.FS)
...
func TestScanner_HiddenFiles(t *testing.T) {
	...
	scanner := handlerpipeline.NewScannerWithFS([]config.Rule{
		{Pattern: "*", Handler: "symlink"},
	}, env.FS)
...
func TestNewScanner(t *testing.T) {
	...
	scanner := handlerpipeline.NewScanner(ruleList)
