...
// executeFill executes the fill command
func executeFill(opts core.CommandExecuteOptions) (*types.PackCommandResult, error) {
...
// init registers the fill command
func init() {
